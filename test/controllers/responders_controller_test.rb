...
class RespondersControllerTest < ActionController::TestCase
  ...
  def test_create
    assert_difference('Responder.count') do
      post :create, responder: { capacity: responder.capacity, emergency_code: responder.emergency_code, name: responder.name, on_duty: responder.on_duty, type_of: responder.type_of }
    end
  ...
  def test_update
    put :update, id: responder, responder: { capacity: responder.capacity, emergency_code: responder.emergency_code, name: responder.name, on_duty: responder.on_duty, type_of: responder.type_of }
    assert_redirected_to responder_path(assigns(:responder))
  end
